...
const charCode = (arr) => {
  // Solution code here...
  return arr.map(v => v.charCodeAt(index));
};
...
const extractAbilities = (arr) => {
  // Solution code here...
  return arr.map((snorlaxAbilities, i) => {
    return snorlaxAbilities.abilities[i].name;
  });
};
...
const extractStats = (arr) => {
  // Solution code here...
  return arr.map(snorlaxStats => {
    snorlaxStats.stats.name;
  });
};
